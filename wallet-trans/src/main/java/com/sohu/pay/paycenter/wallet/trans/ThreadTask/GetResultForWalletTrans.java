 ...
 */
public class GetResultForWalletTrans implements Callable<List<TransInfo>> {
    private final TransInfoService transInfoService;

    private TransInfo transInfo;

    public GetResultForWalletTrans(TransInfo transInfo, TransInfoService transInfoService) {
        this.transInfo = transInfo;
        this.transInfoService = transInfoService;
    }
    @Override
    public List<TransInfo> call() throws Exception {
        return transInfoService.listWalletTrans(transInfo);
    }
}
